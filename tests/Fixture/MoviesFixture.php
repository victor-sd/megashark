...
class MoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'release_date' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'duration' => 1,
            'created' => '2017-12-07 17:25:11',
            'modified' => '2017-12-07 17:25:11',
            'release_date' => '2017-12-07 17:25:11'
        ],
    ];
}
